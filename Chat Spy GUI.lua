...
local spyOnMyself = false -- If true will check your messages too
...
tab.newToggle("Public Italics", "Use /me to stand out more", true, function(state) publicItalics = state end)
