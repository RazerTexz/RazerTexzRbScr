    ...
    for _, v in ipairs(players:GetPlayers()) do
        if v ~= localPlayer and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
            if not teamCheck or teamCheck and v.Team ~= localPlayer.Team then
                ...
                humanoidRootPart.Size = (disableOnDeath and v.Character.Humanoid.Health <= 0) and Vector3.new(0, 0, 0) or Vector3.new(hitboxSize, hitboxSize, hitboxSize)
    ...
    for _, v in ipairs(players:GetPlayers()) do
        if v ~= localPlayer and v.Character and v.Character:FindFirstChild("Head") then
            if not teamCheck or teamCheck and v.Team ~= localPlayer.Team then
                ...
                head.Size = (disableOnDeath and v.Character.Humanoid.Health <= 0) and Vector3.new(0, 0, 0) or Vector3.new(headHitboxSize, headHitboxSize, headHitboxSize)
