...
-- DrRay
local DRR["1"] = Instance.new("ScreenGui", game:GetService("CoreGui"));
...
-- DrRay.TopBar
local DRR["2"] = Instance.new("Frame", DRR["1"]);
...
local DRR["3"] = Instance.new("UICorner", DRR["2"]);
DRR["3"]["CornerRadius"] = UDim.new(0.10000000149011612, 0);

-- DrRay.TopBar.ScrollingFrame
local DRR["4"] = Instance.new("ScrollingFrame", DRR["2"]);
DRR["4"]["Active"] = true;
...
local DRR["5"] = Instance.new("UIListLayout", DRR["4"]);
...
local DRR["8"] = Instance.new("ImageLabel", DRR["7"]);
DRR["8"]["ZIndex"] = 0;
...
local DRR["9"] = Instance.new("UIGradient", DRR["2"]);
DRR["9"]["Rotation"] = 90;
...
-- DrRay.TopBar.TopBar
local DRR["a"] = Instance.new("Frame", DRR["2"]);
...
local DRR["b"] = Instance.new("UIGradient", DRR["a"]);
DRR["b"]["Rotation"] = -90;
...
local DRR["c"] = Instance.new("Frame", DRR["2"]);
...
local DRR["d"] = Instance.new("ImageButton", DRR["c"]);
...
local DRR["10"] = Instance.new("ImageLabel", DRR["d"]);
...
local DRR["14"] = Instance.new("TextLabel", DRR["d"]);
...
local DRR["15"] = Instance.new("UIListLayout", DRR["c"]);
...
local DRR["16"] = Instance.new("UIPadding", DRR["c"]);
DRR["16"]["PaddingLeft"] = UDim.new(0.014000000432133675, 0);

-- DrRay.TopBar.ProfileMenu.Clock
local DRR["17"] = Instance.new("ImageButton", DRR["c"]);
...
local DRR["1a"] = Instance.new("TextLabel", DRR["17"]);
...
local DRR["1b"] = Instance.new("ImageButton", DRR["c"]);
...
local DRR["1e"] = Instance.new("TextLabel", DRR["1b"]);
...
local DRR["1f"] = Instance.new("TextButton", DRR["2"]);
DRR["1f"]["Active"] = false;
...
local DRR["22"] = Instance.new("Frame", DRR["1f"]);
...
local DRR["23"] = Instance.new("UIGradient", DRR["22"]);
DRR["23"]["Rotation"] = 90;
...
local DRR["24"] = Instance.new("UIAspectRatioConstraint", DRR["1f"]);

-- DrRay.TopBar.TopBarClose.ImageLabel
local DRR["25"] = Instance.new("ImageLabel", DRR["1f"]);
...
local DRR["26"] = Instance.new("UIAspectRatioConstraint", DRR["25"]);
DRR["26"]["AspectRatio"] = 0.9836804866790771;

-- DrRay.TopBar.UIAspectRatioConstraint
local DRR["27"] = Instance.new("UIAspectRatioConstraint", DRR["2"]);
DRR["27"]["AspectRatio"] = 5.724700927734375;

-- DrRay.MainBar
local DRR["28"] = Instance.new("Frame", DRR["1"]);
...
local DRR["29"] = Instance.new("UICorner", DRR["28"]);
DRR["29"]["CornerRadius"] = UDim.new(0.029999999329447746, 0);

-- DrRay.MainBar.UIGradient
local DRR["2a"] = Instance.new("UIGradient", DRR["28"]);
DRR["2a"]["Rotation"] = 90;
...
local DRR["2b"] = Instance.new("UIAspectRatioConstraint", DRR["28"]);
DRR["2b"]["AspectRatio"] = 1.7326968908309937;

-- DrRay.MainBar.DropShadowHolder
local DRR["2c"] = Instance.new("Frame", DRR["28"]);
DRR["2c"]["ZIndex"] = 0;
...
local DRR["2d"] = Instance.new("ImageLabel", DRR["2c"]);
DRR["2d"]["ZIndex"] = 0;
...
-- DrRay.MainBar.Logo
local DRR["2e"] = Instance.new("ImageLabel", DRR["28"]);
...
local DRR["2f"] = Instance.new("UIGradient", DRR["2e"]);
DRR["2f"]["Rotation"] = 90;
...
-- DrRay.Folder
local DRR["30"] = Instance.new("Folder", DRR["1"]);

-- DrRay.Folder.TabReserved
local DRR["31"] = Instance.new("ScrollingFrame", DRR["30"]);
DRR["31"]["Active"] = true;
...
local DRR["32"] = Instance.new("UIListLayout", DRR["31"]);
...
local DRR["33"] = Instance.new("ImageButton", DRR["30"]);
...
local DRR["36"] = Instance.new("TextLabel", DRR["35"]);
...
local DRR["37"] = Instance.new("UIListLayout", DRR["35"]);
...
local DRR["38"] = Instance.new("UIGradient", DRR["33"]);
DRR["38"]["Rotation"] = 90;
...
local DRR["39"] = Instance.new("ImageLabel", DRR["33"]);
...
local DRR["3a"] = Instance.new("UIAspectRatioConstraint", DRR["39"]);
DRR["3a"]["AspectRatio"] = 0.9842342734336853;

-- DrRay.Folder.TabButtonReserved.UIListLayout
local DRR["3b"] = Instance.new("UIListLayout", DRR["33"]);
...
local DRR["3c"] = Instance.new("UIPadding", DRR["33"]);
DRR["3c"]["PaddingLeft"] = UDim.new(0.10999999940395355, 0);

-- DrRay.Folder.Dropdown
local DRR["3d"] = Instance.new("Frame", DRR["30"]);
...
local DRR["3e"] = Instance.new("UICorner", DRR["3d"]);
DRR["3e"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Dropdown.UIGradient
local DRR["3f"] = Instance.new("UIGradient", DRR["3d"]);
DRR["3f"]["Rotation"] = 90;
...
local DRR["40"] = Instance.new("TextLabel", DRR["3d"]);
...
local DRR["41"] = Instance.new("TextLabel", DRR["3d"]);
...
local DRR["42"] = Instance.new("Frame", DRR["3d"]);
...
local DRR["45"] = Instance.new("UIStroke", DRR["42"]);
DRR["45"]["Color"] = Color3.fromRGB(40, 45, 62);

-- DrRay.Folder.Dropdown.DropdownBar.Icon
local DRR["46"] = Instance.new("ImageLabel", DRR["42"]);
...
local DRR["47"] = Instance.new("UIAspectRatioConstraint", DRR["46"]);

-- DrRay.Folder.Dropdown.DropdownBar.Open
local DRR["48"] = Instance.new("TextLabel", DRR["42"]);
...
local DRR["49"] = Instance.new("TextButton", DRR["42"]);
...
local DRR["4a"] = Instance.new("Frame", DRR["3d"]);
...
local DRR["4b"] = Instance.new("UIGradient", DRR["4a"]);
DRR["4b"]["Rotation"] = 90;
...
local DRR["4f"] = Instance.new("UIListLayout", DRR["4e"]);
...
local DRR["50"] = Instance.new("Frame", DRR["30"]);
DRR["50"]["Active"] = true;
...
local DRR["51"] = Instance.new("UICorner", DRR["50"]);
DRR["51"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Keybind.UIGradient
local DRR["52"] = Instance.new("UIGradient", DRR["50"]);
DRR["52"]["Rotation"] = 90;
...
local DRR["53"] = Instance.new("TextLabel", DRR["50"]);
...
local DRR["54"] = Instance.new("TextLabel", DRR["50"]);
...
local DRR["55"] = Instance.new("Frame", DRR["50"]);
DRR["55"]["Active"] = true;
...
local DRR["58"] = Instance.new("UIStroke", DRR["55"]);
DRR["58"]["Color"] = Color3.fromRGB(40, 45, 62);

-- DrRay.Folder.Keybind.Bind.Button
local DRR["59"] = Instance.new("TextButton", DRR["55"]);
...
-- DrRay.Folder.Label
local DRR["5a"] = Instance.new("Frame", DRR["30"]);
...
local DRR["5b"] = Instance.new("UICorner", DRR["5a"]);
DRR["5b"]["CornerRadius"] = UDim.new(0.33000001311302185, 0);

-- DrRay.Folder.Label.UIGradient
local DRR["5c"] = Instance.new("UIGradient", DRR["5a"]);
DRR["5c"]["Rotation"] = 90;
...
local DRR["5d"] = Instance.new("TextLabel", DRR["5a"]);
...
-- DrRay.Folder.Slider
local DRR["5e"] = Instance.new("Frame", DRR["30"]);
...
local DRR["5f"] = Instance.new("UICorner", DRR["5e"]);
DRR["5f"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Slider.UIGradient
local DRR["60"] = Instance.new("UIGradient", DRR["5e"]);
DRR["60"]["Rotation"] = 90;
...
local DRR["61"] = Instance.new("TextLabel", DRR["5e"]);
...
local DRR["62"] = Instance.new("Frame", DRR["5e"]);
...
local DRR["65"] = Instance.new("UIStroke", DRR["62"]);
DRR["65"]["Color"] = Color3.fromRGB(0, 255, 39);

-- DrRay.Folder.Slider.ActualSlider.Fill
local DRR["66"] = Instance.new("Frame", DRR["62"]);
...
local DRR["69"] = Instance.new("TextButton", DRR["62"]);
...
local DRR["6c"] = Instance.new("TextLabel", DRR["62"]);
...
local DRR["6d"] = Instance.new("TextLabel", DRR["5e"]);
...
local DRR["6e"] = Instance.new("Frame", DRR["30"]);
...
local DRR["6f"] = Instance.new("UICorner", DRR["6e"]);
DRR["6f"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Textbox.UIGradient
local DRR["70"] = Instance.new("UIGradient", DRR["6e"]);
DRR["70"]["Rotation"] = 90;
...
local DRR["71"] = Instance.new("TextLabel", DRR["6e"]);
...
local DRR["72"] = Instance.new("TextLabel", DRR["6e"]);
...
local DRR["73"] = Instance.new("Frame", DRR["6e"]);
...
local DRR["76"] = Instance.new("UIStroke", DRR["73"]);
DRR["76"]["Color"] = Color3.fromRGB(40, 45, 62);

-- DrRay.Folder.Textbox.TextboxBar.ActualTextbox
local DRR["77"] = Instance.new("TextBox", DRR["73"]);
...
-- DrRay.Folder.Toggle
local DRR["78"] = Instance.new("Frame", DRR["30"]);
DRR["78"]["Active"] = true;
...
local DRR["79"] = Instance.new("UICorner", DRR["78"]);
DRR["79"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Toggle.UIGradient
local DRR["7a"] = Instance.new("UIGradient", DRR["78"]);
DRR["7a"]["Rotation"] = 90;
...
local DRR["7b"] = Instance.new("TextLabel", DRR["78"]);
...
local DRR["7c"] = Instance.new("TextLabel", DRR["78"]);
...
local DRR["7d"] = Instance.new("Frame", DRR["78"]);
...
local DRR["80"] = Instance.new("UIStroke", DRR["7d"]);
...
local DRR["81"] = Instance.new("TextButton", DRR["7d"]);
...
-- DrRay.Folder.Button
local DRR["84"] = Instance.new("TextButton", DRR["30"]);
...
local DRR["85"] = Instance.new("UICorner", DRR["84"]);
DRR["85"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Folder.Button.UIGradient
local DRR["86"] = Instance.new("UIGradient", DRR["84"]);
DRR["86"]["Rotation"] = 90;
...
local DRR["87"] = Instance.new("TextLabel", DRR["84"]);
...
local DRR["88"] = Instance.new("TextLabel", DRR["84"]);
...
local DRR["89"] = Instance.new("TextButton", DRR["30"]);
DRR["89"]["Active"] = false;
...
local DRR["8c"] = Instance.new("UIStroke", DRR["89"]);
DRR["8c"]["Color"] = Color3.fromRGB(40, 45, 62);

-- DrRay.Folder.DropdownButton.name
local DRR["8d"] = Instance.new("TextLabel", DRR["89"]);
...
-- DrRay.Button
local DRR["8e"] = Instance.new("TextButton", DRR["1"]);
...
local DRR["8f"] = Instance.new("UICorner", DRR["8e"]);
DRR["8f"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- DrRay.Button.UIGradient
local DRR["90"] = Instance.new("UIGradient", DRR["8e"]);
DRR["90"]["Rotation"] = 90;
...
-- DrRay.Button.Title
local DRR["91"] = Instance.new("TextLabel", DRR["8e"]);
...
local DRR["92"] = Instance.new("TextLabel", DRR["8e"]);
...
-- DrRay.Library
local DRR["93"] = Instance.new("ModuleScript", DRR["1"]);
DRR["93"]["Name"] = [[Library]];
...
DRR_MODULES[DRR["93"]] = {
    ...
    local function UILIB.newTab(name, img)	
    	...
    	newTabBtn.MouseButton1Click:Connect(function()
    		for _, v in ipairs(parent.TopBar.ScrollingFrame:GetChildren()) do
